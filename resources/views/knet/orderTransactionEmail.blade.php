...
<head>
    ...
    <title><h2>{{ __("website.order_processed_label") }}</h2></title>
                                                    ...
                                                    <table cellpadding="0" style="background: #efefef;" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="left"
                                                                ...
                                                                class="esd-block-text">{{ ucwords(str_replace("_", " ",$key)) }}</td>

                                                            <td align="right" style="color: #79c13b; font-weight: 700;"
                                                                class="esd-block-text">{{ $value }}</td>
                                                        </tr>
                                                        @endforeach
                                                        <tr>
                                                            <td align="left"
                                                                style="padding:15px 0px; font-size: 17px; text-transform: uppercase; font-weight: bold;"
                                                                class="esd-block-text">{{ __('website.order No') }}</td>

                                                            <td align="right" style="color: #79c13b; font-weight: 700;"
                                                                class="esd-block-text">{{ $order['unique_id'] }}</td>
                                                    ...
                                                    <table cellpadding="0" cellspacing="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td class="esd-block-image es-infoblock" align="left"
                                                                ...
                                                                <a style="width: 30px; display: inline-table;" href="{{ $settings->facebook }}"><img
                                                                        src="{{ asset('images/fb.png') }}" alt=""></a>
                                                                <a style="width: 50px; text-align: center ; display: inline-table;"
                                                                   href="{{ $settings->twitter }}"><img src="{{ asset('/images/twit.png') }}"
                                                                                 alt=""></a>
                                                                <a style="width: 50px; text-align: center ; display: inline-table;"
                                                                   href="{{ $settings->instagram }}"><img src="{{ asset('/images/insta.png') }}"
                                                                                 alt=""></a>
                                                            </td>
                                                        </tr>
