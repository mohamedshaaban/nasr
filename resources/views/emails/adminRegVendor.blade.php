        ...
        <td height="130" align="center" valign="top" bgcolor="#cfd6de"><table width="100%" border="0" cellspacing="0" cellpadding="0" >
                ...
                <tr>
                    <td height="274" colspan="2" align="center" valign="middle" bgcolor="#FFFFFF"; style="min-height:300px;">
                        ...
                        <p style="line-height: normal;    padding: 28px 10px 25px 10px;    font-size: 16px;    text-align: center;    font-family: Verdana, Geneva, sans-serif;    border: solid 1px #e4e8eb;    margin: 10px 20px 10px 20px;">   Please verifiy {{$user['name']}}  account from admin side  email by click on <a href="http://bastaat.com/admin/vendors">Vendors</a></p></td>
                </tr>
