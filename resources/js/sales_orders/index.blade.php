            ...
            <div class="box-body table-responsive no-padding">
                ...
                <table class="table table-bordered table-hover ">
                    ...
                    <tbody>
                        ...
                        @if(($order->ordertrack->last()->orderstatus->id == $request->status &&  $request->has('status')) || (! $request->has('status')) )
                        <tr>
                            ...
                            <td>
                                   @foreach ($order->vendororderdeliverycharges as $orderVendorDetails )
                                        {{ number_format((($orderVendorDetails->total ) - $orderVendorDetails->commission_kd) ?(($orderVendorDetails->total ) - $orderVendorDetails->commission_kd) : 0,env('NUMBER_FORMAT')) }} <br />
                                    @endforeach
                            </td>
