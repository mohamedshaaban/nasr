...
class SalesOrdersController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('admin.reports.sales_orders.index')->with([
            'orders' => $orders,
            'allorders' => $allorders,
            'vendors' => $vendors,
            'request' => $request,
    ...
    protected function filterall(Request $request)
    {
        ...
        if ($request->has('search') && $request->has('paymentmethod') && !is_null($request->paymentmethod)) {
            $orders = $orders->where('payment_method',$request->paymentmethod);
        }
